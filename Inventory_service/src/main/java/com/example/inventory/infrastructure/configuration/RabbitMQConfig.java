...
public class RabbitMQConfig {
    ...
    public static final String QUEUE_ORDER_CREATED = "inventory.order.created";
    ...
    public Binding inventoryOrderCreatedBinding(Queue inventoryOrderCreatedQueue, TopicExchange appExchange) {
        return BindingBuilder.bind(inventoryOrderCreatedQueue).to(appExchange).with("order.created");
    }
