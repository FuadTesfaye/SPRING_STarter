...
const GENRES = ['Fiction', 'Non-Fiction', 'Educational', 'Comics', 'Magazines', 'Textbooks', 'Self-Help', 'Biography', 'Science', 'History', 'Romance', 'Mystery', 'Fantasy', 'Horror', 'Poetry', 'Drama', 'Business', 'Travel', 'Cookbooks', 'Art', 'Music', 'Sports', 'Health', 'Children\'s', 'Young Adult', 'Religion', 'Philosophy', 'Psychology', 'Technology', 'Reference'];
...
export default function SellBooksPage() {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.imageUrl.trim()) {
      errors.imageUrl = 'Book image is required';
    }
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="border-b border-gray-200 p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Sell Books</h1>
                <p className="text-gray-600">List your books for sale</p>
              </div>
            </div>
          </div>
          ...
          {submitSuccess && (
            <div className="m-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-center gap-3">
              ...
              <span className="text-green-700">Book added successfully!</span>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Describe the book, condition, edition, summary, etc."
                maxLength={1000}
              />
            ...
            <div className="space-y-4 border-t border-gray-200 pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  {formErrors.genre && <p className="mt-1 text-sm text-red-600">{formErrors.genre}</p>}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., 978-0-06-123456-7"
                  />
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">Featured books appear in the trending section</p>
            </div>
